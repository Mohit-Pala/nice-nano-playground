// this is the default puck descriptor
// the ids assoc are listed below, taken from puck hid cpp
// the id is after 0x85 - so mouse has an id of 0x40
// 75 is the size 
// 95 is the count?

// crazy rabbit hole btw
// https://www.usb.org/sites/default/files/hid1_11.pdf 6.2.2.1 
